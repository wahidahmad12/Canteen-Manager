...
async function initPool(): Promise<void> {
  ...
  const migrations = [
    ...
    `ALTER TABLE quotations ADD COLUMN IF NOT EXISTS attention VARCHAR(200) NOT NULL DEFAULT ''`,
    `ALTER TABLE quotations ADD COLUMN IF NOT EXISTS salutation VARCHAR(50) NOT NULL DEFAULT 'Dear Sir/Madam,'`,
    `CREATE TABLE IF NOT EXISTS contractors (
      ...
      created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
      UNIQUE KEY uq_contractor_code (vendor_code)
    )`,
    `CREATE TABLE IF NOT EXISTS contractor_meal_entries (
      id INT AUTO_INCREMENT PRIMARY KEY,
      ...
      created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
      UNIQUE KEY uq_cme (contractor_id, month, year, meal_type)
    )`,
    `INSERT IGNORE INTO contractors (vendor_code, name, client_name) VALUES
      ('DJ-SKI-001','Aashirbad Enterprise','Cipla Limited'),
      ('DJ-SKI-002','Apprentice','Cipla Limited'),
      ('DJ-SKI-003','Energy Plus','Cipla Limited'),
      ('DJ-SKI-004','GESWARCO-OP. SOCIETY LTD.','Cipla Limited'),
      ('DJ-SKI-005','HR Suman','Cipla Limited'),
      ('DJ-SKI-006','Ishori Devi Sharma','Cipla Limited'),
      ('DJ-SKI-007','Kanchan Enterprise','Cipla Limited'),
      ('DJ-SKI-008','People Strong','Cipla Limited'),
      ('DJ-SKI-009','Rajen Gurung','Cipla Limited'),
      ('DJ-SKI-010','Ranjit Pradhan','Cipla Limited'),
      ('DJ-SKI-011','Sunrise Management Services','Cipla Limited'),
      ('DJ-SKI-012','TeamLease Pvt. Ltd','Cipla Limited'),
      ('DJ-SKI-013','Teekay Management','Cipla Limited'),
      ('DJ-SKI-014','Red Health','Cipla Limited'),
      ('DJ-SKI-015','QUESS','Cipla Limited'),
      ('DJ-SKI-016','CW HR','Cipla Limited'),
      ('DJ-SKI-017','HR','Cipla Limited'),
      ('DJ-SKI-018','Ishori Devi Shram','Cipla Limited'),
      ('DJ-SKI-020','M/s Hari Limboo','Cipla Limited'),
      ('DJ-SKI-021','Blue Spring (Quess)','Cipla Limited'),
      ('DJ-SKI-022','Medi Assist','Cipla Limited'),
