...
const labourWorksPaths = ['/employee-master', '/muster-roll', '/salary', '/skill-wage-rates', '/registers', '/form-xiii', '/bonus-return', '/half-yearly-return', '/leave-with-wages', '/epfo-esic', '/letterhead'];
