...
export default function CashSealMonthly() {
  ...
  const psGrandTotal = psRows.reduce((s, r) => s + r.cashTotal + r.onlineTotal, 0);
  const tpGrandTotal = tpRows.reduce((s, r) => s + r.cashTotal + r.onlineTotal, 0);
        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="flex justify-between items-center bg-gray-800 text-white px-3 py-2 text-sm font-bold rounded mb-4 print:rounded-none">
              <span>Grand Total Income (PS + Third Party)</span>
