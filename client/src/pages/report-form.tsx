...
const DEFAULT_FIXED_ITEMS = [
  ...
  { category: 'fixed', description: 'Dahi 100g Khatta', uom: 'Pcs', qty: 0, rate: 21, amount: 0 },
  { category: 'fixed', description: 'Dahi 100g Sweet', uom: 'Pcs', qty: 0, rate: 22, amount: 0 },
  { category: 'fixed', description: 'Pkt Dahi 1Kg', uom: 'Pkt', qty: 0, rate: 77, amount: 0 },
  { category: 'fixed', description: 'Rasgulla', uom: 'Pcs', qty: 0, rate: 7, amount: 0 },
